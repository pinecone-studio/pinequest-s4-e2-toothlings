...
const StatsSummaryCard = ({ stats }: Props) => {
  ...
  const ACTIONS = [
    { Icon: ClipboardDocumentCheckIcon, label: 'Шалгалт', href: '/dashboard/dentist',   isLink: true },
    { Icon: ClipboardDocumentListIcon,  label: 'Дагалт',  href: '/dashboard/follow-up', isLink: true },
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface p-5 shadow-(--shadow-card) transition-shadow duration-200 hover:shadow-(--shadow-card-lg)">
      <div className="mb-1 flex items-center justify-between">
        ...
        <Link href="/dashboard/admin" className="btn rounded-lg p-1 text-text-muted transition-all duration-150 hover:text-text-base">
